...
export const AuthProvider: React.FC<{children:ReactNode}> = ({children}) => {
 ...
 return <AuthContext.Provider value={{user,role:user?.role||'traveler',pointsBalance:user?.pointsBalance||0,isLoading,login,register,logout,refreshUserData}}>{children}</AuthContext.Provider>;
};
